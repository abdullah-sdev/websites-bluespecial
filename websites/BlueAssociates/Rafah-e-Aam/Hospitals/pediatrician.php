...
<head>
	<meta charset="UTF-8">
	<title>Departments Single || Pediatrician || Hospitals || Responsive HTML 5 Template</title>
                ...
                <nav class="main-menu pull-left">
                    ...
                    <div class="navbar-collapse collapse clearfix">
                        <ul class="navigation clearfix">
                            ...
                            <li class="dropdown current"><a href="departments.php">Departments</a>
                                <ul>
                ...
                <div class="col-md-12">
                    <div class="left pull-left">
                        <ul>
                            ...
                            <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                            <li class="active">Pediatrician</li>
                        </ul>
                    </div>
