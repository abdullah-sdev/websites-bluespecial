...
@section('main-container')
        ...
        <div class="hero">
            ...
            <form action="{{url('/order-report')}}" method="POST" class="animate__animated animate__backInUp vin-report-form">
                @csrf

                <input type="text" class="search-header" placeholder="VIN CHECK NUMBER" name="vin" required
                    title="Enter 17 digit VIN Number" pattern="[a-zA-Z0-9].{16,16}" />
                
                <button type="submit" class="search-glass">
                    <img src="{{url('frontend/img/magnifying-glass.png')}}" alt="" />
                </button>
            </form>
            ...
            <div class="info">
                ...
                <a href="{{url('/HowToOrder')}}"><span>?</span> How to order?</a>
            </div>
        </div>
    </div>
    ...
    <main>
        <div class="container vin-section">
            <div class="info info-3" data-aos="fade-down">
                ...
                <div class="text-list">
                    <div class="img"><img src="{{url('frontend/img/keyboard.svg')}}" alt="" /></div>
                    <div class="text">Enter the VIN number</div>
                </div>
                <div class="text-list">
                    <div class="img"><img src="{{url('frontend/img/cards.svg')}}" alt="" /></div>
                    <div class="text">Choose VIN report</div>
                </div>
                <div class="text-list">
                    <div class="img"><img src="{{url('frontend/img/lightbulb.svg')}}" alt="" /></div>
                    <div class="text">Find out more</div>
                </div>
            </div>

            <div class="info info-2" data-aos="fade-up">
                <img src="{{url('frontend/img/main-report-availability-1.png')}}" class="mid" alt="" />
            </div>
        ...
        <div class="container section-2">
            <div class="info info">
                ...
                <div class="text-list" data-aos="zoom-in-up">
                    <div class="text text-1 animate__animated animate__backInUp">
        ...
        <div class="container section-3">
            <div class="def-card" data-aos="flip-left">
                <div class="img"><img src="{{url('frontend/img/ico-equip-min.svg')}}" alt="" /></div>
            ...
            <div class="def-card" data-aos="flip-up">
                <div class="img"><img src="{{url('frontend/img/ico-damages-min.svg')}}" alt="" /></div>
            ...
            <div class="def-card" data-aos="flip-right">
                <div class="img"><img src="{{url('frontend/img/ico-service-min.svg')}}" alt="" /></div>
            ...
            <div class="def-card" data-aos="flip-left">
                <div class="img"><img src="{{url('frontend/img/ico-stolen-min.svg')}}" alt="" /></div>
            ...
            <div class="def-card" data-aos="flip-down">
                <div class="img"><img src="{{url('frontend/img/ico-photos-min.svg')}}" alt="" /></div>
                <div class="heading-2">Archival photo</div>
                <div class="text-1">
                    Archival photographic documentation of the vehicle
                </div>
            </div>
            <div class="def-card" data-aos="flip-down">
                <div class="img"><img src="{{url('frontend/img/ico-decoder-min.svg')}}" alt="" /></div>
            ...
            <div class="info info">
                ...
                <div class="text-list" data-aos="fade-up">
                    <div class="text text-1">
                        Our <b>VIN decoder</b> will provide you with extensive information
                        encoded by the vehicle manufacturer. With this, you get reliable
                        information about the vehicle you interesting, and even verify the
                        equipment of the vehicle VIN. With this, you get reliable
                        information about the vehicle you interesting, and even verify the
                        equipment of the vehicle VIN. Simply enter the VIN number into our
                        system, and after a few seconds you will receive decoded
                        information. On the basis of report you choose interesting and
                        even check the country of origin of the vehicle. The available
                        payment methods, select the most convenient. Pay, and after a few
                        minutes you will receive a notification e-mail about the
        ...
        <div class="container blogs">
            ...
            <div class="cards-list">
                <div class="card" data-aos="zoom-out-up">
                    ...
                    <div class="cbody">
                        <p class="topic">
                            A car with odometer rollback – what the VIN report will tell us
                            about it
                        </p>
                        <p class="body">
                            A new car is a fresh start. It’s the perfect time to leave our
                            old, tired vehicle behind and upgrade to a sleek, shiny new
                            ride. However, sometimes this means
                        </p>
                    </div>
                </div>
                ...
                <div class="card" data-aos="zoom-out-up">
                    ...
                    <div class="cbody">
                        ...
                        <p class="body">
                            When you purchase a new car, you’ll need to do a couple of
                            things to get that vehicle legally registered in your name.
                            These steps will vary depending on where
                        </p>
                    </div>
                </div>
                ...
                <div class="card" data-aos="zoom-out-up">
                    ...
                    <div class="cbody">
                        ...
                        <p class="body">
                            Buying a car is a stressful decision, especially if you’ve never
                            bought one before – there’s a lot of factors to consider, which
                            might seem intimidating at first. When buying
                        </p>
                    </div>
                </div>
                <div class="card" data-aos="zoom-out-up">
                    ...
                    <div class="cbody">
                        <p class="topic">
                            Always up to date: Mercedes-Benz vehicles are constantly
                ...
                <div class="card" data-aos="zoom-out-up">
                    ...
                    <div class="cbody">
                        <p class="topic">
                            The best in its class rolling up to the starting line: New Audi
                            RS 3 now available to order
                        </p>
                        <p class="body">
                            The new Audi RS 3 is best in its class in terms of acceleration
                            and top speed. The torque splitter, installed in an Audi for the
                            first time, gives the vehicle maximum agility and optimum
                            stability.
                        </p>
                    </div>
                </div>
                ...
                <div class="card" data-aos="zoom-out-up">
                    ...
                    <div class="cbody">
                        ...
                        <p class="body">
                            Mercedes-Benz is further expanding the possibility of keeping
                            programs and systems in the vehicle up to date through updates
                            over the air (OTA). What started with Mercedes-Benz vehicles in
                            the
                        </p>
                    </div>
                </div>
            ...
            <div class="content">
                ...
                <img src="img/pexels-roman-pohorecki-230557.jpg" alt="" class="img-fluid">
                    ...
                    <div class="cntform col-md-12 col-sm-12" data-aos="flip-left">
                        ...
                        <form class="form vin-contact-form"
                            action="https://formsubmit.co/32314913c8f17020ee24a9d5b7bcc20b" method="POST"
                            enctype="multipart/form-data">
                            <input class="form-control form-control-lg" name="name" type="text" placeholder="Name"
                                required aria-label="John Doe" />
                            <input class="form-control form-control-lg" type="email" name="email" placeholder="Email"
                                required aria-label="someone@example.com" />
                            ...
                            <textarea class="form-control form-control-lg" name="body"
                                placeholder="Leave us a Message..!" required id="" cols="30" rows="7"></textarea>
