...
<head>
	<meta charset="UTF-8">
	<title>Testimonials || Hospitals || Responsive HTML 5 Template</title>
                ...
                <div class="single-testimonial-item text-center">
                    <div class="img-box">
                        <div class="img-holder">
                            <img src="images/testimonial/saylani.png" alt="Awesome Image">
                        </div>
                        <div class="quote-box">
...
<!--             
            ...
            <div class="col-md-6">
                <div class="single-testimonial-item text-center">
                    ...
                    <div class="text-holder">
                        <p> Occasionally circumstances occur in which toil and pain can procure great take a trivial example some advantage.</p>
                    </div>
                    <div class="name">
                        <h3>Sibbe Teddy</h3>
            ...
            <div class="col-md-6">
                <div class="single-testimonial-item text-center">
                    ...
                    <div class="text-holder">
                        <p>Desires to obtain pain of itself, because pain, but because occasionally circumstances occur which toil and pain can procure.</p>
                    </div>
                    <div class="name">
                        <h3>Allan Duckeat</h3>
                        <span>Los Angeles</span>
