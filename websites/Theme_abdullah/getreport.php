...
<body>
    <div class="head">
        ...
        <center>
            <div class="navbar">
                <a href="index.php" class="logo"><span>Auto</span>DataRecords</a>
            </div>
        </center>
        ...
        <div class="getreport">
            ...
            <center>
                <form action="" class="vin-report-form" method="post" onsubmit="displayModal(event)">
                    ...
                    <input type="text" name="vin_number" pattern="[a-zA-Z0-9].{16,16}" required id="" disabled
                        value="<?php echo $vinnumber; ?>">
