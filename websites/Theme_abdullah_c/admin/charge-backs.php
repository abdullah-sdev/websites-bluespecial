                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        include "dbconn.php";
                                            $orders = "SELECT * from vinorders Where report_status = 2 ORDER BY reg_date DESC";
                                            ...
                                            if ($r_orders->num_rows > 0) {
                                                ...
                                                <tr>
                                                    ...
                                                    if($row["report_status"] == 0){
                                                        echo '<a class="btn btn-primary" href="update_vinorder.php?operation="1"&id='.$row["vid"].'">Deliver</a>';
                                                        echo '<a class="btn btn-danger" href="#?id='.$row["vid"].'">Charge Back</a>';
                                                    }else{
