...
<head>
	<meta charset="UTF-8">
	<title>Services || Out Patient Department || Hospitals || Responsive HTML 5 Template</title>
                ...
                <div class="col-md-12">
                    <div class="left pull-left">
                        <ul>
                            ...
                            <li><a >Services</a></li>
                            <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                            <li class="active">Out Patient Services</li>
                        </ul>
                    </div>
                        ...
                        <div class="contact-us">
                            <ul class="contact-info">
                                <li>
                                    ...
                                    <div class="text-holder">
                                        <h5>Plot # ST-10 Block 13, <br> Federal B Area Gulburg Town, <br> Karachi, Sindh, Pakistan</h5>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon-holder">
                                ...
                                <li>
                                    ...
                                    <div class="text-holder">
                                        <h5><b>Tel:</b> (021) 36342010-11-12 </h5>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon-holder">
                                    ...
                                    <div class="text-holder">
                                    <h5><b>Cell:</b> 0301 8261314 & <br> 0317 9977114 & <br> 0336 3743774</h5>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon-holder">
