                ...
                <div class="blog-post">
                    ...
                    <div class="single-blog-item wow fadeInUp" data-wow-delay="0s" data-wow-duration="1s" data-wow-offset="0">
                        <div class="img-holder">
                            <img src="images/blog/blog-large-1.jpg" alt="Awesome Image">
                        ...
                        <div class="text-holder">
                            ...
                            <div class="text">
                                <p>The great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter consequences that are extremely painful.</p>
                            </div>
                            <ul class="meta-info">
                    ...
                    <div class="single-blog-item wow fadeInUp" data-wow-delay="0s" data-wow-duration="1s" data-wow-offset="0">
                        <div class="img-holder">
                            <img src="images/blog/blog-large-2.jpg" alt="Awesome Image">
                            <div class="overlay-style-one">
                                <div class="box">
                                    <div class="content">
                                        <a href="blog-single.php"><span class="flaticon-plus-symbol"></span></a>
                        ...
                        <div class="text-holder">
                            ...
                            <div class="text">
                                <p>Who loves or pursues or desires to obtain f itself, because it is pain, because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, which of us ever undertakes laborious physical exercise.</p>
                            </div>
                            <ul class="meta-info">
                                <li><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>February 10, 2017</a></li>
                                <li><a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>28 Comments</a></li>
                                <li><a href="#"><i class="fa fa-folder-open" aria-hidden="true"></i>Transplantation</a></li>
                                <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i>Miles jones</a></li>
                            </ul>
                        </div>    
                    </div>
                    <!--End single blog post-->
                    ...
                    <div class="single-blog-item wow fadeInUp" data-wow-delay="0s" data-wow-duration="1s" data-wow-offset="0">
                        <div class="img-holder">
                            <img src="images/blog/blog-large-3.jpg" alt="Awesome Image">
                            <div class="overlay-style-one">
                                <div class="box">
                                    <div class="content">
                                        <a href="blog-single.php"><span class="flaticon-plus-symbol"></span></a>
                        ...
                        <div class="text-holder">
                            ...
                            <ul class="meta-info">
                                <li><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>February 07, 2017</a></li>
                                <li><a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>23 Comments</a></li>
                                <li><a href="#"><i class="fa fa-folder-open" aria-hidden="true"></i>Transplantation</a></li>
                                <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i>John Alon</a></li>
                            </ul>
                        </div>    
                    </div>
                    <!--End single blog post-->
                    ...
                    <div class="single-blog-item wow fadeInUp" data-wow-delay="0s" data-wow-duration="1s" data-wow-offset="0">
                        <div class="img-holder">
                            <img src="images/blog/blog-large-4.jpg" alt="Awesome Image">
                            <div class="overlay-style-one">
                                <div class="box">
                                    <div class="content">
                                        <a href="blog-single.php"><span class="flaticon-plus-symbol"></span></a>
                        ...
                        <div class="text-holder">
                            <a href="blog-single.php">
                                <h3 class="blog-title">Protecting the brain from Parkinson’s disease</h3>
                            </a>
                            <div class="text">
                                <p>Who loves or pursues or desires to obtain f itself, because it is pain, because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, which of us ever undertakes laborious physical exercise.</p>
                            </div>
                            <ul class="meta-info">
                                <li><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>February 03, 2017</a></li>
                                <li><a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>17 Comments</a></li>
                                <li><a href="#"><i class="fa fa-folder-open" aria-hidden="true"></i>Transplantation</a></li>
                                <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i>Mark Nicholes</a></li>
                            </ul>
                        </div>    
