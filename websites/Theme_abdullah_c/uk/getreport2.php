...
<body>
    ...
    <main>
        ...
        <div class="getreport">
            ...
            <center>
                <form action="blades/transaction.php" method="post">
                    ...
                    <select name="country" id="" value="<?php echo $country; ?>" disabled>
        ...
        data-sdk-integration-source="button-factory"></script>
                    <script
        src="https://www.paypal.com/sdk/js?client-id=ARfcWX5QjaNM42W5QWzYF-HikO-snJUekOI-NKA-5g1PKxSbJiWDZo3o1wNLJ171niNBe21IzLk0VzDr&enable-funding=venmo&currency=USD"
        data-sdk-integration-source="button-factory"></script> -->
        <script>
