            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Active Orders</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        include "dbconn.php";
                                            $orders = "SELECT * from vinorders Where report_status = 0 ORDER BY reg_date DESC";
                                            ...
                                            if ($r_orders->num_rows > 0) {
                                                ...
                                                <tr>
                                                    ...
                                                    if($row["report_status"] == 0){
                                                        echo '<a class="btn btn-success" href="update_vinorder.php?operation=1&id='.$row["vid"].'">Deliver</a>';
                                                        echo '<a class="btn btn-warning" href="update_vinorder.php?operation=2&id='.$row["vid"].'">Charge Back</a>';
                                                    }else{
                                                        echo '<a class="btn btn-primary" href="delete_vinorder.php?id='.$row["vid"].'">Delete</a>';
                                                    }
